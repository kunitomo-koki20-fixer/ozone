...
def leave(chrome, url, headless):
    ...
    try:
        ...
        WebDriverWait(driver, 100).until(EC.presence_of_element_located(LEAVE_BTN)).find_element_by_tag_name("a").click()
        sleep(2)
...
if __name__ == '__main__':
    ...
    url = args.url
    leave(chrome,url,args.headless)
